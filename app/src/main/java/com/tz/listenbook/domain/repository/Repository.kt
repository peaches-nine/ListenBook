package com.tz.listenbook.domain.repository
...
interface ReadingProgressRepository {
    fun getProgress(bookId: Long): Flow<com.tz.listenbook.domain.model.ReadingProgress?>
    fun getAllProgress(): Flow<List<com.tz.listenbook.domain.model.ReadingProgress>>
    suspend fun saveProgress(progress: com.tz.listenbook.domain.model.ReadingProgress)
    suspend fun getAllProgressSnapshot(): List<com.tz.listenbook.domain.model.ReadingProgress>
    suspend fun saveAllProgress(progressList: List<com.tz.listenbook.domain.model.ReadingProgress>)
}